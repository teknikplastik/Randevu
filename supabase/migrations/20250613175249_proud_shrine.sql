/*
  # Doktor Randevu Sistemi - Veritabanı Şeması
  ...
  2. Güvenlik
    ...
    - Public erişim için gerekli politikalar
    - Admin yetkilendirme politikaları

  3. Başlangıç Verileri
    - Dr. Eren Sağıroğlu doktor kaydı
...
-- RLS Policies for doctors (Public read access for active doctors)
...
-- RLS Policies for appointments (Public can create, authenticated can manage)
...
-- RLS Policies for admin_users (Public read for login, authenticated for management)
...
-- RLS Policies for settings (Public read access)
...
INSERT INTO doctors (name, specialty, phone, address, working_hours, appointment_duration) 
VALUES (
  'Uzm. Dr. Eren Sağıroğlu', 
  'Çocuk Doktoru', 
  '0531 893 16 22', 
  'Yahyakaptan Mah. Şht. Ali İhsan Çakmak Sk. No:8, 41050 İzmit/Kocaeli',
  '{
...
INSERT INTO settings (site_title, site_description, is_active) 
VALUES (
  'Dr. Eren Sağıroğlu - Çocuk Doktoru', 
  'Uzm. Dr. Eren Sağıroğlu ile çocuk doktoru randevusu alın. Kocaeli İzmit''te güvenilir pediatri hizmeti.',
  true
) ON CONFLICT DO NOTHING;
